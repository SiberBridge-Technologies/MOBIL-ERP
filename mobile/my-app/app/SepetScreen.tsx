    ...
    <View style={styles.container}>
      ...
      <View style={styles.searchWrap}>
        <TextInput
          ...
          placeholder="?r?n kodu veya ismi ara..."
      ...
      <View style={styles.cartHeader}>
        <Text style={styles.sectionTitle}>
          Alisveris Sepeti ({items.length} ?r?n)
        </Text>
      </View>
      ...
      {items.length === 0 ? (
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyTitle}>
            Alisveris Sepeti Bos
          </Text>

          <Text style={styles.emptyText}>
            Sepetinizde ?r?n bulunmamaktadir.
            {'\n'}
            Yukaridaki arama kutusundan
            sepetinize hizlica ?r?n ekleyin.
          </Text>
        </View>
      ) : (
        <FlatList
